...
export class AboutMeComponent implements OnInit {
  ...
  introduce1: string = "Công ty TNHH kiến trúc nội thất A Decor là công ty hoạt động trong lĩnh vực tư vấn thiết kế, thi công các công trình kiến trúc, nội thất..";
